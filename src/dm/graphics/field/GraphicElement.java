...
public abstract class GraphicElement{
	...
	public GraphicElement(String picture,int x, int y, int width, int height) {
		this.x = x;
		this.y = y;
		this.width = width;
		this.height = height;
	...
	public GraphicElement(String picture,int x, int y, int width, int height,float alpha) {
		this.x = x;
		this.y = y;
		this.width = width;
		this.height = height;
