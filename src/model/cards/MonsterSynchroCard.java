...
public class MonsterSynchroCard extends MonsterCard implements ExtraDeckCard {

	private static final long serialVersionUID = -7850575761434909539L;

	public MonsterSynchroCard(String name, String description, String picture, MonsterType type, MonsterAttribute atribute,int level,
	...
	public MonsterSynchroCard(String name, String description, MonsterType type, MonsterAttribute atribute,int level,
			int originalAttack, int originalDeffense, int state, Effect effect, int copies_number) {
		this(name, description,name + ".jpg", type, atribute,level, originalAttack, originalDeffense,state, effect,
				copies_number);
	}
	
	public MonsterSynchroCard() {
	...
	public MonsterSynchroCard(int copies_number) {
