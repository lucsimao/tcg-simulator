...
public class MonsterXYZCard extends MonsterCard implements ExtraDeckCard {

	private static final long serialVersionUID = -7850575761434909539L;

	public MonsterXYZCard(String name, String description, String picture, MonsterType type, MonsterAttribute atribute,int level,
	...
	public MonsterXYZCard(String name, String description, MonsterType type, MonsterAttribute atribute,int level,
			int originalAttack, int originalDeffense, int state, Effect effect, int copies_number) {
		this(name, description,name + ".jpg", type, atribute,level, originalAttack, originalDeffense,state, effect,
				copies_number);
	}
	
	public MonsterXYZCard() {
	...
	public MonsterXYZCard(int copies_number) {
