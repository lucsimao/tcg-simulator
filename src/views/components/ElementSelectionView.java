...
public class ElementSelectionView extends ElementView {

	private final int DELAY = 71;
	protected Thread thread;
	private Color color;
	
	public ElementSelectionView(int x, int y, int width, int height, float alpha, Color color) {
		super(null, x, y, width, 0);
		this.color = color;
		thread = new Thread();
	}

	public ElementSelectionView(int x, int y, int width, int height) {
