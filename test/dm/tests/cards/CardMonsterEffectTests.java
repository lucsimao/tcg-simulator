...
public class CardMonsterEffectTests extends CardMonsterTests {
	...
	public void initCard() {
		setCard(new MonsterEffectCard(name, description, null, type, atribute, originalAttack, originalDefense,
	...
	public void checkIfEffectIsNotNull() {
		...
		setCard(new MonsterEffectCard(name, description, null, type, atribute, originalAttack, originalDefense, null,
				copies_number));
