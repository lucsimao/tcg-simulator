...
public class FieldSpellTrapTests {
	...
	public void initCards() throws NoEffectException {
		spellCard = new SpellCard("Dark Hole", "Destroy all monster on the field", null, new Effect(), SpellType.NORMAL,
				3);
		trapCard = new TrapCard("Mirror Force", "Destroy all attacking monsters", null, new Effect(), TrapType.NORMAL,
				3);
		field = new Field();
	}
